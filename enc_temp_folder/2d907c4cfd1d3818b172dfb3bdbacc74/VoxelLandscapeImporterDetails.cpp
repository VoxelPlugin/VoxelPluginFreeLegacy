...
FReply UVoxelLandscapeImporterDetails::OnCreateFromLandscape()
{
	if (LandscapeImporter->Landscape)
	{
		...
		UVoxelLandscapeAsset* LandscapeAsset = (UVoxelLandscapeAsset*)LandscapeFactory->FactoryCreateNew(UVoxelLandscapeAsset::StaticClass(), Package, "Name", RF_Standalone | RF_Public, NULL, GWarn);
