...
public:
	...
	explicit TVoxelStaticArray(EForceInit)
	{
	...
	void CopyFromArray(const TArray<T, Allocator>& Array, bool bInitializeEnd = true)
	{
	...
	void SetFromVariadicArgs(T Arg, TArgs... Args)
	{
	...
	void SetFromVariadicArgs(T Arg)
	{
