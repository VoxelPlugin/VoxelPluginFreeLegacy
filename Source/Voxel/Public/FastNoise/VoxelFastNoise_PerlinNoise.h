...
public:
	...
	GENERATED_VOXEL_NOISE_FUNCTION_FRACTAL_2D(Perlin)
	GENERATED_VOXEL_NOISE_FUNCTION_FRACTAL_2D_DERIV(Perlin)
	GENERATED_VOXEL_NOISE_FUNCTION_FRACTAL_3D(Perlin)
	GENERATED_VOXEL_NOISE_FUNCTION_FRACTAL_3D_DERIV(Perlin)
