...
public:
	...
	GENERATED_VOXEL_NOISE_FUNCTION_FRACTAL_2D(Value)
	GENERATED_VOXEL_NOISE_FUNCTION_FRACTAL_2D_DERIV(Value)
	GENERATED_VOXEL_NOISE_FUNCTION_FRACTAL_3D(Value)
	GENERATED_VOXEL_NOISE_FUNCTION_FRACTAL_3D_DERIV(Value)
